...
public class IzinOffSteps {

    private WebDriver driver = Hooks.driver;
    private LoginPage loginPage = new LoginPage(driver);
    private KoreksiPage koreksiPage = new KoreksiPage(driver);

    @Given("User is on login page for izin off page")
    public void user_Is_On_Login_Page_for_izin_off_page() {
        driver.get("https://magang.dikahadir.com/authentication/login");
    }

    @When("User enters valid email and password for izin off page")
    public void user_enters_valid_email_and_password_for_izin_off_page() {
        loginPage.enterEmail("admin@hadir.com");
        loginPage.enterPassword("admin@hadir");
    }

    @And("User clicks login button for izin off page")
    public void user_clicks_login_button_for_izin_off_page() {
        loginPage.clickLoginButton();
    }

//    @And("User should be redirected to dashboard for izin off page")
//    public void user_should_be_redirected_to_dashboard_for_izin_off_page() {
