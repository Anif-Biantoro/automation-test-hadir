...
public class LoginUserSteps {
    ...
    public void user_enters_valid_email_and_password_for_login_user() {
        loginPage.enterEmail("mhmmdasshidiqii@gmail.com");
        loginPage.enterPassword("kikidiqi1");
        delay(1);
    }
...
//    @And("User should be redirected to dashboard for login user")
//    public void user_should_be_redirected_to_dashboard_for_login_user() {
